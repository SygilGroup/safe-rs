...
pub enum SafeRoute {
    ...
    Messages(String),
    Modules(String),
    MultisigTransactions(String),
    MultisigTransactionsConfirmations(String),
    SafesByOwner(String),
    Safe(String),
    SafeTransactions(String),
    SafeBalances(String),
    SafeIncomingTransfers(String),
    SafeMessages(String),
    SafeModuleTransactions(String),
    SafeMultisigTransactions(String),
